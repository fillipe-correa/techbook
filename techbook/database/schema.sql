...
(2, 'Harry Potter e a Camara Secreta', 'J.K. Rowling', 'Fantasia', 'O segundo ano de Harry traz novos mistérios.', 'https://covers.openlibrary.org/b/isbn/9788532511669-L.jpg', 5, 5, 'DISPONIVEL'),
...
(4, 'Dom Casmurro', 'Machado de Assis', 'Romance', 'Um clássico da literatura brasileira.', 'https://covers.openlibrary.org/b/isbn/9788525412300-L.jpg', 3, 3, 'DISPONIVEL'),
(5, 'Clean Code', 'Robert C. Martin', 'Tecnologia', 'Boas práticas para desenvolvimento de software.', 'https://covers.openlibrary.org/b/isbn/9780132350884-L.jpg', 2, 2, 'DISPONIVEL'),
(6, 'Entendendo Algoritmos', 'Aditya Bhargava', 'Tecnologia', 'Introdução visual a algoritmos e estruturas.', 'https://covers.openlibrary.org/b/isbn/9788575225638-L.jpg', 3, 2, 'DISPONIVEL');
